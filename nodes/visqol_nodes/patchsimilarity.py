...
class PatchSimilarityNode(ViSQOLNode):
    ...
    def __init__(self, id_, children, output_key, draw_options=None, **kwargs):
    ...
    def execute(self, result, **kwargs):
        freq_band_sim = constants.FREQ_BAND_SIM_FUNCTIONS[result['visqol_args'].arguments.freq_band_simn_per_patch]
        ...
        degraded_patches = result['degraded_patches']
        ...
        if result['visqol_args'].arguments.is_low_pass_filtered(fvnsim):
